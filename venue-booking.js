(function () {
  ...
  */
  ...
  root.innerHTML = ''
    ...
    + '  </div>'
    + '</section>'
    + '<div class="gkv-note">Velg starttid og varighet. Dersom dart, disc-simulator eller klubbkveld allerede er booket/reservert, blir overlappende privatkveld automatisk sperret. Booking stenger 20 minutter før start.</div>'
    + '<section class="gkv-extra">'
    + '  <div>'
    + '    <div class="gkv-extra-title">Varighet</div>'
    + '    <div class="gkv-extra-sub">Velg 4 timer eller legg til ekstra timer. Pris: 200 kr per time.</div>'
    + '  </div>'
    + '  <label class="gkv-extra-select">'
    + '    <span>Velg</span>'
    + '    <select id="gkv-duration-hours">'
    + '      <option value="4">4 timer – 800 kr</option>'
    + '      <option value="5">5 timer – 1000 kr</option>'
    + '      <option value="6">6 timer – 1200 kr</option>'
    + '      <option value="7">7 timer – 1400 kr</option>'
    + '      <option value="8">8 timer – 1600 kr</option>'
    + '      <option value="9">9 timer – 1800 kr</option>'
    + '      <option value="10">10 timer – 2000 kr</option>'
    + '      <option value="11">11 timer – 2200 kr</option>'
    + '      <option value="12">12 timer – 2400 kr</option>'
    + '    </select>'
    + '  </label>'
    + '</section>'
    + '<section class="gkv-extra">'
    + '  <div>'
    + '    <div class="gkv-extra-title">Leie pilsett</div>'
    + '    <div class="gkv-extra-sub">Valgfritt tillegg dersom dere trenger ekstra dartpiler.</div>'
    + '  </div>'
    + '  <label class="gkv-extra-select">'
    + '    <span>Antall</span>'
    + '    <select id="gkv-dartset-count">'
    + '      <option value="0">0 pilsett</option>'
    + '      <option value="1">1 pilsett</option>'
    + '      <option value="2">2 pilsett</option>'
    + '      <option value="3">3 pilsett</option>'
    + '      <option value="4">4 pilsett</option>'
    + '      <option value="5">5 pilsett</option>'
    + '      <option value="6">6 pilsett</option>'
    + '    </select>'
    + '  </label>'
    + '</section>'
