  ...
  */
  ...
  function injectCss() {
    ...
    style.textContent = ""
      ...
      + "@media(max-width:640px){.gkv-hero{padding:14px;border-radius:18px}.gkv-weekbar{align-items:flex-start;flex-direction:column}.gkv-weekbuttons{width:100%}.gkv-weekbtn{flex:1}.gkv-body{padding:12px}.gkv-slot{padding:12px}.gkv-time{font-size:20px}.gkv-day{min-width:102px}}";
  ...
  function renderSlots(dateStr) {
    ...
    if (!times.length) {
      slotsEl.innerHTML = '<div class="gkv-empty">Ingen tider for leie av hele lokalet denne dagen.</div>';
      return;
    }
  ...
  function createSlotCard(slot) {
    ...
    reason.textContent = lock ? (lock.reason || "Tiden er ikke tilgjengelig.") : "Inkluderer begge dartbaner, disc-simulator, møtebord og fri kaffe.";
